...
#    tf.reset_default_graph()
    ...
    with tf.Session() as sess:
        saver = tf.train.Saver()
        saver.restore(sess, './experiment/HYPER_GammaDecay_Policy/Flower_000_constant/model/model.ckpt')
...
if __name__ == '__main__':
    ...
    main(data_set, 'VAE', 256, num_epoch=200, log_gamma_decay=log_gamma_decay, beta_policy_type=beta_policy_type)
